...
<body>
    ...
    <div id="content_r" class="col-sm-10" style="color:silver">
        ...
        <div class="r_content">
            <form action="listPark.do" method="post" role="form" class="form-inline pull-right" id="userform">
                    ...
                    <tbody>
                        ...
                        <form id="condition">
                            ...
                            <input type="hidden" name="room" id="room"
                                value="${condition.room}" /> <input type="hidden" name="status"
                                id="status" value="${condition.status}" />
                                <input type="hidden" name="carnum"
                                id="carnum" value="${condition.carnum}" />
                            <!-- 分页信息 -->
    ...
    function fnSearch(){
        $("#userform").attr("action","listPa.do");
